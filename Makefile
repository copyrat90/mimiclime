...
PYTHON      	:=  python
SOURCES     	:=  src src/ut src/scn src/gm src/gm/cfg src/gm/ecs src/gm/ecs/cpn src/gm/ecs/cpn/impl src/gm/ecs/sys src/gm/ecs/sys/impl src/gm/ecs/ut src/txt $(LIBBUTANOLDTK)/src $(BUILDLDTK)/src $(LIBISOBUTANO)/src $(BUILDDATA)/src
...
TEXTS       	:=  include/txt src/txt $(BUILDLDTK)/src $(BUILDLDTK)/include $(LICENSES)
