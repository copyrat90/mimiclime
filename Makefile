...
LICENSES    	:=  licenses
PYTHON      	:=  python
SOURCES     	:=  src src/ut src/scn src/gm src/gm/cfg src/gm/ecs src/gm/ecs/cpn src/gm/ecs/sys characters/gen/src $(LIBBUTANOLDTK)/src $(BUILDLDTK)/src $(LIBISOBUTANO)/src
