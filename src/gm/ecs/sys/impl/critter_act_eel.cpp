...
constexpr bn::fixed ATTACK_MOVE_SPEED_MULTIPLIER = 0.125f;
constexpr decltype(cpn::critter_states::attack_countdown) ATTACK_COOLDOWN = 25;

} // namespace

void critter_act_eel(const gba::entity critter, actor_registry& actor_reg)
{
    auto& states = actor_reg.get<cpn::critter_states>(critter);
    [[maybe_unused]] auto& substates = states.substates<cpn::impl::critter_substates_eel>();
