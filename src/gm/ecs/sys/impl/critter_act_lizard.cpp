...
constexpr bn::fixed ATTACK_MOVE_SPEED_MULTIPLIER = 0.25f;
constexpr decltype(cpn::critter_states::attack_countdown) ATTACK_COOLDOWN = 20;

} // namespace

void critter_act_lizard(const gba::entity critter, actor_registry& actor_reg)
{
