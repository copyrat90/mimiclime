...
void collision_detect(actor_registry& actor_reg)
{
    ...
    actor_reg.view<cpn::breakable_states>().each([&](const gba::entity breakable,
        ...
        {
            const bn::top_left_fixed_rect breakable_hurtbox(breakable_pos.x() + rel_breakable_hurtbox.x,
                                                            breakable_pos.y() + rel_breakable_hurtbox.y,
                                                            rel_breakable_hurtbox.width, rel_breakable_hurtbox.height);
